...
var HTMLworkEmployer = '<a target="_blank" <a href="#">%data%';
...
var HTMLprojectTitle = '<a target="_blank"<a href="#">%data%</a>';
var HTMLprojectDates = '<div class="date-text">%data%</div>';
var HTMLprojectDescription = '<p><br>%data%</p>';
var HTMLprojectImage = '<img src="%data%">';

var HTMLschoolStart = '<div class="education-entry"></div>';
var HTMLschoolName = '<a target="_blank"<a href="#">%data%';
...
var HTMLonlineTitle = '<a target="_blank" <a href="#">%data%';
